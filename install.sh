...
git clone https://github.com/atemporalzen/ASM/ /tmp/ASM/ && mv /tmp/ASM/scripts/ $HOME/ASM/scripts/
...
# 2)GitHub Dorking
git clone https://github.com/atemporalzen/GitDorkertweak.git $HOME/ASM/tools/gitdorker
